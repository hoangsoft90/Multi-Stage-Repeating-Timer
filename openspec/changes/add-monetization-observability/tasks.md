...
- [x] 4.2 Denied/Restricted → cấu hình non-personalized ads fallback, ads vẫn serve
...
- [x] 5.2 Metrics: `timer_started` (preset_id, repeat_mode, số stage, tổng duration), `ad_shown`/`ad_clicked` (placement), `permission_denied` (tách theo loại), `att_status`
...
- [x] 6.4 Checklist pre-submit: Privacy Policy URL, 8 Remote Config keys trên console, ATT timing, non-personalized fallback
